...
import { signIn, signUpAdmin, signOut } from "../lib/supabase";
...
const Login = ({ onLogin }: LoginProps) => {
  ...
  const handleLogin = async (e?: React.FormEvent) => {
    ...
    if (!email.trim() || !password.trim()) {
      setLoginError("Veuillez saisir votre identifiant et mot de passe.");
      return;
    }
    ...
    <div className="min-h-screen flex" style={{ background: "#eef3fc" }}>
      ...
      >
        ...
        <div className="relative z-10 p-14 flex flex-col h-full">
          ...
          <div className="text-white/20 text-xs">© 2026 StationPro · Powered by Supabase</div>
        </div>
      </motion.div>
